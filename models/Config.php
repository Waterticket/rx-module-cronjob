...
namespace Rhymix\Modules\Cronjob\Models;
...
class Config
{
	...
	public static function getConfig()
	{
		if (self::$_cache === null)
		{
			self::$_cache = ModuleModel::getModuleConfig('cronjob') ?: new \stdClass;
		}
		return self::$_cache;
	}
	...
	public static function setConfig($config)
	{
		...
		$result = $oModuleController->insertModuleConfig('cronjob', $config);
		if ($result->toBool())
		{
			self::$_cache = $config;
		}
