...
use Rhymix\Modules\Cronjob\Models\Config as ConfigModel;
use BaseObject;
use Context;
...
class Admin extends Base
{
	 ...
	 * 관리자 설정 화면 예제
	 */
	public function dispCronjobAdminConfig()
	{
		// 현재 설정 상태 불러오기
		$config = ConfigModel::getConfig();
		
		// Context에 세팅
		Context::set('cronjob_config', $config);
	 ...
	 * 관리자 설정 저장 액션 예제
	 */
	public function procCronjobAdminInsertConfig()
	{
		// 현재 설정 상태 불러오기
		$config = ConfigModel::getConfig();
